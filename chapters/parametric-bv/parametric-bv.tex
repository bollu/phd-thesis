...
Tobias Grosser.
\emph{My contributions:} the initial algorithm---handling the mono-width case and
...
and \cref{sec:pbv:single-width} showed how to decide predicates in the
mono-width setting ($\text{PBV}_1$). However, the theory of \emph{parametric} bitvectors
...
only one width variable, we recover the mono-width parametric bitvector
...
For the mono-width setting, we fill the gap in ITP proof automation for
...
correctness argument for the generalization. The mono-width results, by
