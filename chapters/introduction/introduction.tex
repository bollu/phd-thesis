...
Next, to build push-button automation,
there was a question of what style of decision procedure to build.
We wish to balance the competing concerns of \emph{performance} and \emph{trustworthiness}.
Subtle algorithms can be fast, but are hard to verify.
On the other hand, simple algorithms are easy to verify, but can be far too slow to be useful.
I settled on bitblasting, since I had been helping implement \bvdecide{}~\citep{leanbv},
Lean's fixed-width bitvector tactic.
\bvdecide{} starts with a bitvector goal, performs bitblasting to produce an equivalent SAT problem,
dispatches it to a state-of-the-art SAT solver,
and has the resulting certificate rechecked by Lean's kernel.
This design depends heavily on the incredible progess in the last two decades
...
Overall, the design of \bvdecide{} deliberately mirrors Bitwuzla~\citep{niemetz2023bitwuzla},
...
and what flavours of problems were solvable by bitblasting.
Overall, \bvdecide{} gave us the automation we needed to verify rewrites at a \emph{concrete} bitwidth,
...
However, we show that this is unnecessary.
