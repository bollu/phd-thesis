...
\emph{given a peephole rewrite, how do I prove it correct, with no SMT solver in the trusted base?}
...
since one can reduce a problem in a rich theory to propositional logic,
and then dispatch it to a state-of-the-art SAT solver.
