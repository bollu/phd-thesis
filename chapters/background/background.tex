...
representations, so I recall the relevant vocabulary. Static single
...
Building on this vocabulary, I develop Lean-MLIR~\citep{leanmlir}, a
...
(\cref{ch:mono-width,ch:multi-width,ch:floating-point}).
