...
at speed inside a proof assistant---without giving up the scalability that makes
them useful. It made the case along a single arc. \Cref{ch:lean-mlir} built a
