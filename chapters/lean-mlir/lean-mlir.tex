...
representations (IRs). This is a workhorse of modern compilers. Recall that
...
framework~\citep{lattner2021mlir}.
As CompCert-style end-to-end verification cannot keep pace with IRs
that are still evolving, and Alive-style validation is push-button but
bound to one fixed IR and an unverified toolchain, 
we propose a new approach: we combine the convenience of automation of Alive-style validation
with machine-checked proofs of correctness in an interactive theorem prover (ITP).
