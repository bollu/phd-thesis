...
\paragraph{RQ1: meeting Alive on its own ground.}
...
\paragraph{RQ1: parametricity after the fact.}
...
\paragraph{RQ1: past the reach of SMT.}
...
\subsection{The Cost of Instantiation}
\label{sec:mlir:cost}
