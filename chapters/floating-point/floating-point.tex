...
benchmarks our solver runs at a geometric-mean slowdown of
\SmtLibGeomeanTimeElapsedRatioOB{} relative to Bitwuzla, while offering
end-to-end correctness guarantees. On new benchmarks
...
whose unknown soundness in current solvers we want to fix due to application to ML workloads. We crystallize these into the following research questions:
...
We answer \textbf{RQ2} affirmatively, as our solver is faster than exhaustive enumeration by a geomean factor of \SmallFpTimeElapsedRatioON{} and by \SmallFpTimeoutSpeedupLB{} on the hardest instances,
