...
This makes implenting production-grade compilers complex, and proving them correct even more so.
...
Moreover, proving this correct requires one to prove the correctness of each individual rewrite,
along with a proof that the rewriter as a whole is correct.
...
which is decided by $k$-induction and regular language emptiness.
